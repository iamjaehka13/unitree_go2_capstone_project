...
OUTPUT="${REPO_ROOT}/project/results/no_push_eval/no_push_eval_v1_contactpen_2000_seed0.csv"
EPISODES=20
NUM_ENVS=20
SEED=0
DEVICE="cuda:0"
...
echo "[INFO] v1 contact-penalty no-push eval started at $(date --iso-8601=seconds)"
...
run_condition \
  ...
  "${REPO_ROOT}/logs/rsl_rl/go2_fr_failure_default_stand/2026-05-04_10-43-39_v1_contactpen_2000_seed0_e1_fr_default"

run_condition \
  "Unitree-Go2-FR-Failure-Tripod-Stand" \
  "${REPO_ROOT}/logs/rsl_rl/go2_fr_failure_tripod_stand/2026-05-04_11-03-38_v1_contactpen_2000_seed0_e2_fr_tripod"

echo
echo "[INFO] v1 contact-penalty no-push eval finished at $(date --iso-8601=seconds)"
