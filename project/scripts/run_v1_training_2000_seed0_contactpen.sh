...
echo "[INFO] v1 contact-penalty 2000-iteration training started at $(date --iso-8601=seconds)"
...
run_train "Unitree-Go2-FR-Failure-Default-Stand" "v1_contactpen_2000_seed0_e1_fr_default"
run_train "Unitree-Go2-FR-Failure-Tripod-Stand" "v1_contactpen_2000_seed0_e2_fr_tripod"

echo
echo "[INFO] v1 contact-penalty 2000-iteration training finished at $(date --iso-8601=seconds)"
